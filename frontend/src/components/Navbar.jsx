...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-4 left-1/2 -translate-x-1/2 w-[95%] lg:w-[85%] z-50">
            <div className="bg-[#6f482a]/95 backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.2)]
                        ...
                        <div className="flex items-center gap-5">
                            <Link to="/cart">
                                <div className="relative">
                                    <FaShoppingCart size={26} className="text-white hover:text-[#f3d2ae] transition" />
                ...
                <ul className="flex flex-col space-y-4 px-6 text-[#8b5e3c] font-semibold">
                    ...
                    <div className="flex flex-col-1 gap-5">
                        ...
                        <Link to="/order" onClick={() => setOpen(false)}>
                            <button className="w-42 px-6 py-2 rounded-full bg-gradient-to-r from-[#dda56a] to-[#e8b381] 
                        text-white font-semibold shadow-lg hover:scale-105 transition">
                                Order Now
                            </button>
                        </Link>
                        ...
                        {isLoggedIn ? (
                            ...
                            <div className="flex items-center gap-5 ml-auto">
                                ...
                                <Link to="/cart">
                                    <div className="relative">
                                        <FaShoppingCart size={26} className="text-[#8b5e3c] hover:text-[#f3d2ae] transition" />
